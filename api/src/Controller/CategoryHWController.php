...
class CategoryHWController extends AbstractController
{
    ...
    public function create(Request $request): JsonResponse
    {
        ...
        if (!isset($requestData['imgName'], $requestData['name'], $requestData['description'])) {
            throw new Exception("Invalid request data");
        }

        $category = new CategoryHW();
        $category->setName($requestData['name'])->setImgName($requestData['imgName'])->setDescription($requestData['description']);
